...
class SiteController extends Controller
{
    ...
    public function __construct($id, Module $module, PasswordResetService $passwordResetService, ContactService $contactService, SignUpService $signupService, array $config = [])
    {
